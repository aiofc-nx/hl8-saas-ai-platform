...
import { UserUnlockedHandler } from './user-unlocked.handler.js';

describe('UserUnlockedHandler', () => {
  let handler: UserUnlockedHandler;

  beforeEach(() => {
    handler = new UserUnlockedHandler();
  });

  it('应处理用户解锁事件', async () => {
    const event = new UserUnlockedEvent({
